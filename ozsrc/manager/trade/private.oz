...
class Dictionary <String, Directory<Broker>> : Set <Assoc <String, Directory<Broker>>>
...
/* method implementations */
      Assoc <String, Directory<Broker>> AddAssoc (String key, Directory<Broker> value) {
	  Assoc <String, Directory<Broker>> a=>New (key, value);
	  Assoc <String, Directory<Broker>> b = Add (a);
      ...
      Assoc <String, Directory<Broker>> AssocAt (String key) {return FindObjectWithKey (key);}

      Directory<Broker> AtKey (String key) {
	  Assoc <String, Directory<Broker>> assoc = FindObjectWithKey (key);
      ...
      Assoc <String, Directory<Broker>> FindObjectWithKey (String key) {
      ...
      Assoc <String, Directory<Broker>> RemoveKey (String key) {
	  Assoc <String, Directory<Broker>> assoc = FindObjectWithKey (key);
      ...
      Directory<Broker> SetAtKey (String key, Directory<Broker> data) {
	  Assoc <String, Directory<Broker>> assoc = FindObjectWithKey (key);
	  ...
	  Set <String> s=>New ();
	  Iterator <Assoc <String, Directory<Broker>>> i;
	  Assoc <String, Directory<Broker>> assoc;
