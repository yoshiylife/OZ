...
shared CollectionExceptions <Assoc<String,Command>> {
    ElementNotFound (Assoc<String,Command> );
    Empty ();
    InternalError (Assoc<String,Command> );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,Command> );
    UnknownKey (Assoc<String,Command> );
}
