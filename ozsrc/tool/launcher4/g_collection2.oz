...
abstract class Collection <ProjectLinkSS> {
...
/* abstract methods */
    ProjectLinkSS Add (ProjectLinkSS content) : abstract;
    ProjectLinkSS DoNext (Iterator <ProjectLinkSS> i) : abstract;
    unsigned int Hash () : abstract;
    int IsEqual (Collection <ProjectLinkSS> collection) : abstract;
    unsigned int OccurrencesOf (ProjectLinkSS content) : abstract;
    ProjectLinkSS Remove (ProjectLinkSS content) : abstract;

/* method inplementation */
    Collection <ProjectLinkSS> AddAll (Collection <ProjectLinkSS> collection) {
	collection->AddContentsTo (self);
	return collection;
    }

    Collection <ProjectLinkSS> AddContentsTo (Collection <ProjectLinkSS> collection){
    ...
    void DoFinish (Iterator <ProjectLinkSS> i) {}

    void DoReset (Iterator <ProjectLinkSS> i) {}

    int Includes (ProjectLinkSS content) {return OccurrencesOf (content) != 0;}
    ...
    void NewWithCollection (Collection <ProjectLinkSS> collection) {
	New ();
	AddAll (collection);
    }

    Collection <ProjectLinkSS> RemoveAll (Collection <ProjectLinkSS> collection) {
	Iterator <ProjectLinkSS> i;
	ProjectLinkSS content;
