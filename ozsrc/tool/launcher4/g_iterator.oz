...
class Iterator <Assoc<String,ProjectLinkSS>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <Assoc<String,ProjectLinkSS>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <Assoc<String,ProjectLinkSS>> collection) {
    ...
    Assoc<String,ProjectLinkSS> PostIncrement () {return aCollection->DoNext (self);}
