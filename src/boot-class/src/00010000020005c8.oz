...
class Dictionary <String, String> : Set <Assoc <String, String>>
...
/* method implementations */
      Assoc <String, String> AddAssoc (String key, String value) {
	  Assoc <String, String> a=>New (key, value);
	  Assoc <String, String> b = Add (a);
      ...
      Assoc <String, String> AssocAt (String key) {return FindObjectWithKey (key);}

      String AtKey (String key) {
	  Assoc <String, String> assoc = FindObjectWithKey (key);
      ...
      Assoc <String, String> FindObjectWithKey (String key) {
      ...
      Assoc <String, String> RemoveKey (String key) {
	  Assoc <String, String> assoc = FindObjectWithKey (key);
      ...
      String SetAtKey (String key, String data) {
	  Assoc <String, String> assoc = FindObjectWithKey (key);
