...
class Set <OIDAsKey<global DirectoryServer<Package>>> : Collection <OIDAsKey<global DirectoryServer<Package>>>
  (rename New SuperNew;
...
/* instance variables */
    ...
    OIDAsKey<global DirectoryServer<Package>> Contents [];
...
/* method implementations */
    ...
    OIDAsKey<global DirectoryServer<Package>> Add (OIDAsKey<global DirectoryServer<Package>> t) {
    ...
    Set <OIDAsKey<global DirectoryServer<Package>>> AddContentsTo (Set <OIDAsKey<global DirectoryServer<Package>>> collection){
    ...
    Set <OIDAsKey<global DirectoryServer<Package>>> Difference (Set <OIDAsKey<global DirectoryServer<Package>>> s) {
	unsigned int i;
	Set <OIDAsKey<global DirectoryServer<Package>>> diff = ShallowCopy ();
    ...
    OIDAsKey<global DirectoryServer<Package>> DoNext (Iterator <OIDAsKey<global DirectoryServer<Package>>> pos) {
    ...
    OIDAsKey<global DirectoryServer<Package>> FindObjectWithKey (OIDAsKey<global DirectoryServer<Package>> key) {
	...
	OIDAsKey<global DirectoryServer<Package>> o;
    ...
    int IsEqual (Collection <OIDAsKey<global DirectoryServer<Package>>> s) {
	return IsSubSetOf (s) && IsSuperSetOf (s);
    }

    int IsSubSetOf (Collection <OIDAsKey<global DirectoryServer<Package>>> collection) {
    ...
    int IsSuperSetOf (Collection <OIDAsKey<global DirectoryServer<Package>>> collection) {
	if (Count < collection->Size ()) {
	    return 0;
	} else {
	    Iterator <OIDAsKey<global DirectoryServer<Package>>> i=>New (collection);
	    OIDAsKey<global DirectoryServer<Package>> c;
     ...
     */
    unsigned int OccurrencesOf (OIDAsKey<global DirectoryServer<Package>> t) {
     ...
     */
    OIDAsKey<global DirectoryServer<Package>> Remove (OIDAsKey<global DirectoryServer<Package>> t) {
	unsigned int i = FindIndexOf (t);
	OIDAsKey<global DirectoryServer<Package>> rob = Contents [i];

	if (rob == 0) {
	    raise CollectionExceptions<OIDAsKey<global DirectoryServer<Package>>>::ElementNotFound (t);
	} else {
	    unsigned int j, r;
    ...
    OIDAsKey<global DirectoryServer<Package>> RemoveAny () {
	if (Size () == 0) {
	    raise CollectionExceptions<OIDAsKey<global DirectoryServer<Package>>>::Empty;
	} else {
	    unsigned int n = length Contents, i;
	...
	if (new_size <= Count) {
	    raise
	      CollectionExceptions<OIDAsKey<global DirectoryServer<Package>>>::InvalidIntParameter (new_size);
	}
	if (Count > 0) {
	    unsigned int n = length Contents;
	    OIDAsKey<global DirectoryServer<Package>> old_contents [] = Contents;
	    OIDAsKey<global DirectoryServer<Package>> new_contents [];

	    length new_contents = SetCapacity (new_size);
	    Contents = new_contents;
	    for (i = 0; i < n; i ++) {
		OIDAsKey<global DirectoryServer<Package>> t = old_contents [i];
		if (t != 0) {
		    Add (t);
		}
	    }
    ...
    Set <OIDAsKey<global DirectoryServer<Package>>> Intersection (Set <OIDAsKey<global DirectoryServer<Package>>> s) {
	Set <OIDAsKey<global DirectoryServer<Package>>> set_intersection = ShallowCopy ();
	unsigned int n = length Contents;
	unsigned int i;
    ...
    Set <OIDAsKey<global DirectoryServer<Package>>> ShallowCopy () {
	Iterator <OIDAsKey<global DirectoryServer<Package>>> i;
	OIDAsKey<global DirectoryServer<Package>> content;
	Set <OIDAsKey<global DirectoryServer<Package>>> new=>NewWithSize (Size ());
    ...
    Set <OIDAsKey<global DirectoryServer<Package>>> Union (Set <OIDAsKey<global DirectoryServer<Package>>> s) {
	Set <OIDAsKey<global DirectoryServer<Package>>> set_union = ShallowCopy ();
...
/* protected method implementations below */
     ...
     */
    unsigned int FindIndexOf (OIDAsKey<global DirectoryServer<Package>> t) {
	unsigned int i;
