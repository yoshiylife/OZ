...
class Iterator <Assoc<String,Directory<T>>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <Assoc<String,Directory<T>>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <Assoc<String,Directory<T>>> collection) {
    ...
    Assoc<String,Directory<T>> PostIncrement () {return aCollection->DoNext (self);}
