...
class Iterator <Assoc<String,int>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <Assoc<String,int>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <Assoc<String,int>> collection) {
    ...
    Assoc<String,int> PostIncrement () {return aCollection->DoNext (self);}
