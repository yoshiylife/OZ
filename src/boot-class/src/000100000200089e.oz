...
class Iterator <MirrorOperation> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <MirrorOperation> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <MirrorOperation> collection) {
    ...
    MirrorOperation PostIncrement () {return aCollection->DoNext (self);}
