...
shared CollectionExceptions <Assoc<String,global DirectoryServer<global ResolvableObject>>> {
    ElementNotFound (Assoc<String,global DirectoryServer<global ResolvableObject>>  );
    Empty ();
    InternalError (Assoc<String,global DirectoryServer<global ResolvableObject>>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,global DirectoryServer<global ResolvableObject>>  );
    UnknownKey (Assoc<String,global DirectoryServer<global ResolvableObject>>  );
}
