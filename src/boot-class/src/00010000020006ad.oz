...
class Iterator <Assoc<String,global DirectoryServer<Package>>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <Assoc<String,global DirectoryServer<Package>>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <Assoc<String,global DirectoryServer<Package>>> collection) {
    ...
    Assoc<String,global DirectoryServer<Package>> PostIncrement () {return aCollection->DoNext (self);}
