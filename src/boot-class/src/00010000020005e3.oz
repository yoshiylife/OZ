...
abstract class Collection <Assoc<String,int>> {
...
/* abstract methods */
    Assoc<String,int> Add (Assoc<String,int> content) : abstract;
    Assoc<String,int> DoNext (Iterator <Assoc<String,int>> i) : abstract;
    unsigned int Hash () : abstract;
    int IsEqual (Collection <Assoc<String,int>> collection) : abstract;
    unsigned int OccurrencesOf (Assoc<String,int> content) : abstract;
    Assoc<String,int> Remove (Assoc<String,int> content) : abstract;

/* method inplementation */
    Collection <Assoc<String,int>> AddAll (Collection <Assoc<String,int>> collection) {
	collection->AddContentsTo (self);
	return collection;
    }

    Collection <Assoc<String,int>> AddContentsTo (Collection <Assoc<String,int>> collection){
    ...
    Assoc<String,int> AsArray () [] {
	Assoc<String,int> array [];
	Iterator <Assoc<String,int>> i;
	Assoc<String,int> t;
	unsigned int j = 0;
    ...
    void DoFinish (Iterator <Assoc<String,int>> i) {}

    void DoReset (Iterator <Assoc<String,int>> i) {}

    int Includes (Assoc<String,int> content) {return OccurrencesOf (content) != 0;}
    ...
    void NewWithCollection (Collection <Assoc<String,int>> collection) {
	New ();
	AddAll (collection);
    }

    Collection <Assoc<String,int>> RemoveAll (Collection <Assoc<String,int>> collection) {
	Iterator <Assoc<String,int>> i;
	Assoc<String,int> content;
