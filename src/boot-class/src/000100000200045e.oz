...
/* instance variables */
    Collection <Assoc<T,T>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <Assoc<T,T>> collection) {
    ...
    Assoc<T,T> PostIncrement () {return aCollection->DoNext (self);}
