...
shared CollectionExceptions <Assoc<String,Package>> {
    ElementNotFound (Assoc<String,Package>  );
    Empty ();
    InternalError (Assoc<String,Package>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,Package>  );
    UnknownKey (Assoc<String,Package>  );
}
