...
class SimpleArray <global Object> {
/* interface */
...
/* method implementations */
	...
	if (shrink_factor > shrink_threshold) {
	    raise
	      CollectionExceptions <global Object>
    ...
    void Add (global Object c) : locked {
	AddImpl (c);
    }

    void AddImpl (global Object c) {
    ...
    void AddArray (global Object a []) : locked {
    ...
    global Object AsArray ()[] : locked {
	global Object table [] = Table;

	length table = NumberOfElement;
	return table;
    }

    global Object At (unsigned int i) : locked {
	if (i < NumberOfElement) {
	    return Table [i];
	} else {
	    raise CollectionExceptions <global Object>::InvalidIntParameter (i);
	}
    }
    ...
    global Object Content ()[] : locked {
	global Object content [] = Table;
    ...
    int Includes (global Object c) : locked {
	unsigned int i;
    ...
    unsigned int Lookup (global Object c) : locked {return LookupImpl (c);}

    unsigned int LookupImpl (global Object c) {
	unsigned int i;
    ...
    global Object Remove (global Object c) : locked {
	unsigned int index = LookupImpl (c);

	if (index != length Table && Table [index] == c) {
	    return RemoveAtImpl (index);
	} else {
	    raise CollectionExceptions <global Object>::ElementNotFound (c);
	}
    }

    global Object RemoveAt (unsigned int index) : locked {
	if (0 <= index && index < NumberOfElement) {
	    return RemoveAtImpl (index);
	} else {
	    raise CollectionExceptions <global Object>::InvalidIntParameter (index);
	}
    }

    global Object RemoveAtImpl (unsigned int index) {
	global Object ret = Table [index];
	unsigned int i;
    ...
    void Set (global Object elements []) : locked {
	global Object tmp [] = Table;
	unsigned int i, len;
	...
	if (elements != 0) {
	    ...
	    raise CollectionExceptions <global Object>::InvalidParameter;
	}
    }

    void Shrink () {
	global Object tmp_table [];
	unsigned int i;
	unsigned int capacity = length Table;
