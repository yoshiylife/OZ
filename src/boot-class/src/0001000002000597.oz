...
class Dictionary <String, global DirectoryServer<T>> : Set <Assoc <String, global DirectoryServer<T>>>
...
/* method implementations */
      Assoc <String, global DirectoryServer<T>> AddAssoc (String key, global DirectoryServer<T> value) {
	  Assoc <String, global DirectoryServer<T>> a=>New (key, value);
	  Assoc <String, global DirectoryServer<T>> b = Add (a);
      ...
      Assoc <String, global DirectoryServer<T>> AssocAt (String key) {return FindObjectWithKey (key);}

      global DirectoryServer<T> AtKey (String key) {
	  Assoc <String, global DirectoryServer<T>> assoc = FindObjectWithKey (key);
      ...
      Assoc <String, global DirectoryServer<T>> FindObjectWithKey (String key) {
      ...
      Assoc <String, global DirectoryServer<T>> RemoveKey (String key) {
	  Assoc <String, global DirectoryServer<T>> assoc = FindObjectWithKey (key);
      ...
      global DirectoryServer<T> SetAtKey (String key, global DirectoryServer<T> data) {
	  Assoc <String, global DirectoryServer<T>> assoc = FindObjectWithKey (key);
	  ...
	  Assoc <String, global DirectoryServer<T>> assoc;
