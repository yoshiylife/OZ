...
class Iterator <Assoc<String,Directory<Package>>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <Assoc<String,Directory<Package>>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <Assoc<String,Directory<Package>>> collection) {
    ...
    Assoc<String,Directory<Package>> PostIncrement () {return aCollection->DoNext (self);}
