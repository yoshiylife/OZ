...
shared CollectionExceptions <Assoc<String,int>> {
    ElementNotFound (Assoc<String,int>  );
    Empty ();
    InternalError (Assoc<String,int>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,int>  );
    UnknownKey (Assoc<String,int>  );
}
