...
shared CollectionExceptions <Assoc<String,Directory<T>>> {
    ElementNotFound (Assoc<String,Directory<T>>  );
    Empty ();
    InternalError (Assoc<String,Directory<T>>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,Directory<T>>  );
    UnknownKey (Assoc<String,Directory<T>>  );
}
