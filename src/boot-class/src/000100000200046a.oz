...
abstract class Collection <String> {
...
/* abstract methods */
    String Add (String content) : abstract;
    String DoNext (Iterator <String> i) : abstract;
    unsigned int Hash () : abstract;
    int IsEqual (Collection <String> collection) : abstract;
    unsigned int OccurrencesOf (String content) : abstract;
    String Remove (String content) : abstract;

/* method inplementation */
    Collection <String> AddAll (Collection <String> collection) {
	collection->AddContentsTo (self);
	return collection;
    }

    Collection <String> AddContentsTo (Collection <String> collection){
	Iterator <String> i;
	String content;
    ...
    void DoFinish (Iterator <String> i) {}

    void DoReset (Iterator <String> i) {}

    int Includes (String content) {return OccurrencesOf (content) != 0;}
    ...
    void NewWithCollection (Collection <String> collection) {
	New ();
	AddAll (collection);
    }

    Collection <String> RemoveAll (Collection <String> collection) {
	Iterator <String> i;
	String content;
