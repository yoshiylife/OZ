...
class Iterator <Assoc<String,Package>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <Assoc<String,Package>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <Assoc<String,Package>> collection) {
    ...
    Assoc<String,Package> PostIncrement () {return aCollection->DoNext (self);}
