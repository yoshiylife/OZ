...
class Iterator <Assoc<String,global ResolvableObject>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <Assoc<String,global ResolvableObject>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <Assoc<String,global ResolvableObject>> collection) {
    ...
    Assoc<String,global ResolvableObject> PostIncrement () {return aCollection->DoNext (self);}
