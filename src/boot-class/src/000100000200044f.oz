...
shared CollectionExceptions <global ConfigurationID> {
    ElementNotFound (global ConfigurationID  );
    Empty ();
    InternalError (global ConfigurationID  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (global ConfigurationID  );
    UnknownKey (global ConfigurationID  );
}
