...
class LockSet <global DirectoryServer<global ResolvableObject>>
  : Set <OIDAsKey <global DirectoryServer<global ResolvableObject>>> (rename New SuperNew;
			       rename Add SuperAdd;
...
/* instance variables */
  protected: Locked, ID;
    ...
    Set <OIDAsKey <global DirectoryServer<global ResolvableObject>>> Locked;
    global LockID ID;
...
/* method implementations */
    ...
    global DirectoryServer<global ResolvableObject> Add (global DirectoryServer<global ResolvableObject> t) {
	OIDAsKey <global DirectoryServer<global ResolvableObject>> key=>New (t);
    ...
    int Includes (global DirectoryServer<global ResolvableObject> t) {
	OIDAsKey <global DirectoryServer<global ResolvableObject>> key=>New (t);
    ...
    global DirectoryServer<global ResolvableObject> Remove (global DirectoryServer<global ResolvableObject> t) {
	OIDAsKey <global DirectoryServer<global ResolvableObject>> key=>New (t);
