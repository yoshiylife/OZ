...
class Iterator <Assoc<String,String>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <Assoc<String,String>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <Assoc<String,String>> collection) {
    ...
    Assoc<String,String> PostIncrement () {return aCollection->DoNext (self);}
