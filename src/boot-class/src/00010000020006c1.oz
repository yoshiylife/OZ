...
class Dictionary <String, Package> : Set <Assoc <String, Package>>
...
/* method implementations */
      Assoc <String, Package> AddAssoc (String key, Package value) {
	  Assoc <String, Package> a=>New (key, value);
	  Assoc <String, Package> b = Add (a);
      ...
      Assoc <String, Package> AssocAt (String key) {return FindObjectWithKey (key);}

      Package AtKey (String key) {
	  Assoc <String, Package> assoc = FindObjectWithKey (key);
      ...
      Assoc <String, Package> FindObjectWithKey (String key) {
      ...
      Assoc <String, Package> RemoveKey (String key) {
	  Assoc <String, Package> assoc = FindObjectWithKey (key);
      ...
      Package SetAtKey (String key, Package data) {
	  Assoc <String, Package> assoc = FindObjectWithKey (key);
