...
class SimpleTable <global ClassID, Date> {
/* interface */
...
/* method implementations */
    ...
    Date Add (global ClassID k, Date v) : locked {
	Date ret;
	unsigned int index;
    ...
    Date AtKey (global ClassID k) : locked {
    ...
    Date RemoveKey (global ClassID k) : locked {
	unsigned int index = FindIndexOf (k);
