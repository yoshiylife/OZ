...
shared CollectionExceptions <Assoc<String,global DirectoryServer<Package>>> {
    ElementNotFound (Assoc<String,global DirectoryServer<Package>>  );
    Empty ();
    InternalError (Assoc<String,global DirectoryServer<Package>>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,global DirectoryServer<Package>>  );
    UnknownKey (Assoc<String,global DirectoryServer<Package>>  );
}
