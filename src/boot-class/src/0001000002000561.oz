...
class Dictionary <String, Directory<T>> : Set <Assoc <String, Directory<T>>>
...
/* method implementations */
      Assoc <String, Directory<T>> AddAssoc (String key, Directory<T> value) {
	  Assoc <String, Directory<T>> a=>New (key, value);
	  Assoc <String, Directory<T>> b = Add (a);
      ...
      Assoc <String, Directory<T>> AssocAt (String key) {return FindObjectWithKey (key);}

      Directory<T> AtKey (String key) {
	  Assoc <String, Directory<T>> assoc = FindObjectWithKey (key);
      ...
      Assoc <String, Directory<T>> FindObjectWithKey (String key) {
      ...
      Assoc <String, Directory<T>> RemoveKey (String key) {
	  Assoc <String, Directory<T>> assoc = FindObjectWithKey (key);
      ...
      Directory<T> SetAtKey (String key, Directory<T> data) {
	  Assoc <String, Directory<T>> assoc = FindObjectWithKey (key);
	  ...
	  Assoc <String, Directory<T>> assoc;
