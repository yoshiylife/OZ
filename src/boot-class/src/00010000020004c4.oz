...
shared CollectionExceptions <global ConfiguredClassID> {
    ElementNotFound (global ConfiguredClassID  );
    Empty ();
    InternalError (global ConfiguredClassID  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (global ConfiguredClassID  );
    UnknownKey (global ConfiguredClassID  );
}
