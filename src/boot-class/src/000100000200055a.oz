...
class Iterator <OIDAsKey<global ClassID>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <OIDAsKey<global ClassID>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <OIDAsKey<global ClassID>> collection) {
    ...
    OIDAsKey<global ClassID> PostIncrement () {return aCollection->DoNext (self);}
