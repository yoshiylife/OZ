...
shared CollectionExceptions <Assoc<String,ProjectLinkSS>> {
    ElementNotFound (Assoc<String,ProjectLinkSS>  );
    Empty ();
    InternalError (Assoc<String,ProjectLinkSS>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,ProjectLinkSS>  );
    UnknownKey (Assoc<String,ProjectLinkSS>  );
}
