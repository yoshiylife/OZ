...
class Dictionary <String, Command> : Set <Assoc <String, Command>>
...
/* method implementations */
      Assoc <String, Command> AddAssoc (String key, Command value) {
	  Assoc <String, Command> a=>New (key, value);
	  Assoc <String, Command> b = Add (a);
      ...
      Assoc <String, Command> AssocAt (String key) {return FindObjectWithKey (key);}

      Command AtKey (String key) {
	  Assoc <String, Command> assoc = FindObjectWithKey (key);
      ...
      Assoc <String, Command> FindObjectWithKey (String key) {
      ...
      Assoc <String, Command> RemoveKey (String key) {
	  Assoc <String, Command> assoc = FindObjectWithKey (key);
      ...
      Command SetAtKey (String key, Command data) {
	  Assoc <String, Command> assoc = FindObjectWithKey (key);
