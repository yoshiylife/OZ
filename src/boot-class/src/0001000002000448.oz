...
shared CollectionExceptions <global VersionID> {
    ElementNotFound (global VersionID  );
    Empty ();
    InternalError (global VersionID  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (global VersionID  );
    UnknownKey (global VersionID  );
}
