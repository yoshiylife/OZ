...
abstract class SequencedCollection <OIDAsKey<T>> : Collection <OIDAsKey<T>> {
...
/* abstract methods */
    OIDAsKey<T> At (unsigned int index) : abstract;
    void AtAllPut (OIDAsKey<T> o) : abstract;
...
/* method implementations */
    OIDAsKey<T> DoNext (Iterator <OIDAsKey<T>> i) {
