...
shared CollectionExceptions <Assoc<String,String>> {
    ElementNotFound (Assoc<String,String>  );
    Empty ();
    InternalError (Assoc<String,String>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,String>  );
    UnknownKey (Assoc<String,String>  );
}
