...
/* instance variables */
  ...
  protected: Debug;
    ...
    Dictionary <String, Directory <Package>> Subdirectories;
    Dictionary <String, Package> Entries;
...
/* method implementations */
    ...
    void AddDirectory (String name, Directory <Package> d) {
	Subdirectories->AddAssoc (name, d);
    }

    void AddEntry (String name, Package e) {
    ...
    Directory <Package> RemoveDirectory (String name) {
	return Subdirectories->RemoveKey (name)->Value ();
    }

    Package RemoveEntry (String name) {
    ...
    Package Retrieve (String name) {
	return Entries->AtKey (name);
    }

    Directory <Package> RetrieveDirectory (String name) {
	return Subdirectories->AtKey (name);
    }

    Package Update (String name, Package new) {
