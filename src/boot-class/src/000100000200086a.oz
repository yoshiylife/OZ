...
shared CollectionExceptions <global ClassPackageID> {
    ElementNotFound (global ClassPackageID  );
    Empty ();
    InternalError (global ClassPackageID  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (global ClassPackageID  );
    UnknownKey (global ClassPackageID  );
}
