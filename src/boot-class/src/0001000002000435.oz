...
shared CollectionExceptions <global ClassID> {
    ElementNotFound (global ClassID  );
    Empty ();
    InternalError (global ClassID  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (global ClassID  );
    UnknownKey (global ClassID  );
}
