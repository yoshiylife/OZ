 ...
 * part.oz
 *
 * Enumeration constants for class part names
 */

shared ClassPartName {
    unsigned int aRootPart = 0;
    unsigned int aPublicPart = 1;
    unsigned int aProtectedPart = 2;
    unsigned int anImplementationPart = 3;
    unsigned int aConfiguredClass = 4;
}
