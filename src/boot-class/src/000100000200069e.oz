...
class Set <Assoc<String,global DirectoryServer<Package>>> : Collection <Assoc<String,global DirectoryServer<Package>>>
  (rename New SuperNew;
...
/* instance variables */
    ...
    Assoc<String,global DirectoryServer<Package>> Contents [];
...
/* method implementations */
    ...
    Assoc<String,global DirectoryServer<Package>> Add (Assoc<String,global DirectoryServer<Package>> t) {
    ...
    Set <Assoc<String,global DirectoryServer<Package>>> AddContentsTo (Set <Assoc<String,global DirectoryServer<Package>>> collection){
    ...
    Set <Assoc<String,global DirectoryServer<Package>>> Difference (Set <Assoc<String,global DirectoryServer<Package>>> s) {
	unsigned int i;
	Set <Assoc<String,global DirectoryServer<Package>>> diff = ShallowCopy ();
    ...
    Assoc<String,global DirectoryServer<Package>> DoNext (Iterator <Assoc<String,global DirectoryServer<Package>>> pos) {
    ...
    Assoc<String,global DirectoryServer<Package>> FindObjectWithKey (Assoc<String,global DirectoryServer<Package>> key) {
	...
	Assoc<String,global DirectoryServer<Package>> o;
    ...
    int IsEqual (Collection <Assoc<String,global DirectoryServer<Package>>> s) {
	return IsSubSetOf (s) && IsSuperSetOf (s);
    }

    int IsSubSetOf (Collection <Assoc<String,global DirectoryServer<Package>>> collection) {
    ...
    int IsSuperSetOf (Collection <Assoc<String,global DirectoryServer<Package>>> collection) {
	if (Count < collection->Size ()) {
	    return 0;
	} else {
	    Iterator <Assoc<String,global DirectoryServer<Package>>> i=>New (collection);
	    Assoc<String,global DirectoryServer<Package>> c;
     ...
     */
    unsigned int OccurrencesOf (Assoc<String,global DirectoryServer<Package>> t) {
     ...
     */
    Assoc<String,global DirectoryServer<Package>> Remove (Assoc<String,global DirectoryServer<Package>> t) {
	unsigned int i = FindIndexOf (t);
	Assoc<String,global DirectoryServer<Package>> rob = Contents [i];

	if (rob == 0) {
	    raise CollectionExceptions<Assoc<String,global DirectoryServer<Package>>>::ElementNotFound (t);
	} else {
	    unsigned int j, r;
    ...
    Assoc<String,global DirectoryServer<Package>> RemoveAny () {
	if (Size () == 0) {
	    raise CollectionExceptions<Assoc<String,global DirectoryServer<Package>>>::Empty;
	} else {
	    unsigned int n = length Contents, i;
	...
	if (new_size <= Count) {
	    raise
	      CollectionExceptions<Assoc<String,global DirectoryServer<Package>>>::InvalidIntParameter (new_size);
	}
	if (Count > 0) {
	    unsigned int n = length Contents;
	    Assoc<String,global DirectoryServer<Package>> old_contents [] = Contents;
	    Assoc<String,global DirectoryServer<Package>> new_contents [];

	    length new_contents = SetCapacity (new_size);
	    Contents = new_contents;
	    for (i = 0; i < n; i ++) {
		Assoc<String,global DirectoryServer<Package>> t = old_contents [i];
		if (t != 0) {
		    Add (t);
		}
	    }
    ...
    Set <Assoc<String,global DirectoryServer<Package>>> Intersection (Set <Assoc<String,global DirectoryServer<Package>>> s) {
	Set <Assoc<String,global DirectoryServer<Package>>> set_intersection = ShallowCopy ();
	unsigned int n = length Contents;
	unsigned int i;
    ...
    Set <Assoc<String,global DirectoryServer<Package>>> ShallowCopy () {
	Iterator <Assoc<String,global DirectoryServer<Package>>> i;
	Assoc<String,global DirectoryServer<Package>> content;
	Set <Assoc<String,global DirectoryServer<Package>>> new=>NewWithSize (Size ());
    ...
    Set <Assoc<String,global DirectoryServer<Package>>> Union (Set <Assoc<String,global DirectoryServer<Package>>> s) {
	Set <Assoc<String,global DirectoryServer<Package>>> set_union = ShallowCopy ();
...
/* protected method implementations below */
     ...
     */
    unsigned int FindIndexOf (Assoc<String,global DirectoryServer<Package>> t) {
	unsigned int i;
