...
class Dictionary <String, Directory<Package>> : Set <Assoc <String, Directory<Package>>>
...
/* method implementations */
      Assoc <String, Directory<Package>> AddAssoc (String key, Directory<Package> value) {
	  Assoc <String, Directory<Package>> a=>New (key, value);
	  Assoc <String, Directory<Package>> b = Add (a);
      ...
      Assoc <String, Directory<Package>> AssocAt (String key) {return FindObjectWithKey (key);}

      Directory<Package> AtKey (String key) {
	  Assoc <String, Directory<Package>> assoc = FindObjectWithKey (key);
      ...
      Assoc <String, Directory<Package>> FindObjectWithKey (String key) {
      ...
      Assoc <String, Directory<Package>> RemoveKey (String key) {
	  Assoc <String, Directory<Package>> assoc = FindObjectWithKey (key);
      ...
      Directory<Package> SetAtKey (String key, Directory<Package> data) {
	  Assoc <String, Directory<Package>> assoc = FindObjectWithKey (key);
	  ...
	  Assoc <String, Directory<Package>> assoc;
