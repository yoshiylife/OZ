...
shared CollectionExceptions <Assoc<String,T>> {
    ElementNotFound (Assoc<String,T>  );
    Empty ();
    InternalError (Assoc<String,T>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,T>  );
    UnknownKey (Assoc<String,T>  );
}
