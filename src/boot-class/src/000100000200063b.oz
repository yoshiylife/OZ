...
class Set <Assoc<String,global ResolvableObject>> : Collection <Assoc<String,global ResolvableObject>>
  (rename New SuperNew;
...
/* instance variables */
    ...
    Assoc<String,global ResolvableObject> Contents [];
...
/* method implementations */
    ...
    Assoc<String,global ResolvableObject> Add (Assoc<String,global ResolvableObject> t) {
    ...
    Set <Assoc<String,global ResolvableObject>> AddContentsTo (Set <Assoc<String,global ResolvableObject>> collection){
    ...
    Set <Assoc<String,global ResolvableObject>> Difference (Set <Assoc<String,global ResolvableObject>> s) {
	unsigned int i;
	Set <Assoc<String,global ResolvableObject>> diff = ShallowCopy ();
    ...
    Assoc<String,global ResolvableObject> DoNext (Iterator <Assoc<String,global ResolvableObject>> pos) {
    ...
    Assoc<String,global ResolvableObject> FindObjectWithKey (Assoc<String,global ResolvableObject> key) {
	...
	Assoc<String,global ResolvableObject> o;
    ...
    int IsEqual (Collection <Assoc<String,global ResolvableObject>> s) {
	return IsSubSetOf (s) && IsSuperSetOf (s);
    }

    int IsSubSetOf (Collection <Assoc<String,global ResolvableObject>> collection) {
    ...
    int IsSuperSetOf (Collection <Assoc<String,global ResolvableObject>> collection) {
	if (Count < collection->Size ()) {
	    return 0;
	} else {
	    Iterator <Assoc<String,global ResolvableObject>> i=>New (collection);
	    Assoc<String,global ResolvableObject> c;
     ...
     */
    unsigned int OccurrencesOf (Assoc<String,global ResolvableObject> t) {
     ...
     */
    Assoc<String,global ResolvableObject> Remove (Assoc<String,global ResolvableObject> t) {
	unsigned int i = FindIndexOf (t);
	Assoc<String,global ResolvableObject> rob = Contents [i];

	if (rob == 0) {
	    raise CollectionExceptions<Assoc<String,global ResolvableObject>>::ElementNotFound (t);
	} else {
	    unsigned int j, r;
    ...
    Assoc<String,global ResolvableObject> RemoveAny () {
	if (Size () == 0) {
	    raise CollectionExceptions<Assoc<String,global ResolvableObject>>::Empty;
	} else {
	    unsigned int n = length Contents, i;
	...
	if (new_size <= Count) {
	    raise
	      CollectionExceptions<Assoc<String,global ResolvableObject>>::InvalidIntParameter (new_size);
	}
	if (Count > 0) {
	    unsigned int n = length Contents;
	    Assoc<String,global ResolvableObject> old_contents [] = Contents;
	    Assoc<String,global ResolvableObject> new_contents [];

	    length new_contents = SetCapacity (new_size);
	    Contents = new_contents;
	    for (i = 0; i < n; i ++) {
		Assoc<String,global ResolvableObject> t = old_contents [i];
		if (t != 0) {
		    Add (t);
		}
	    }
    ...
    Set <Assoc<String,global ResolvableObject>> Intersection (Set <Assoc<String,global ResolvableObject>> s) {
	Set <Assoc<String,global ResolvableObject>> set_intersection = ShallowCopy ();
	unsigned int n = length Contents;
	unsigned int i;
    ...
    Set <Assoc<String,global ResolvableObject>> ShallowCopy () {
	Iterator <Assoc<String,global ResolvableObject>> i;
	Assoc<String,global ResolvableObject> content;
	Set <Assoc<String,global ResolvableObject>> new=>NewWithSize (Size ());
    ...
    Set <Assoc<String,global ResolvableObject>> Union (Set <Assoc<String,global ResolvableObject>> s) {
	Set <Assoc<String,global ResolvableObject>> set_union = ShallowCopy ();
...
/* protected method implementations below */
     ...
     */
    unsigned int FindIndexOf (Assoc<String,global ResolvableObject> t) {
	unsigned int i;
