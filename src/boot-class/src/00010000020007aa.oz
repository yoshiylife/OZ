...
class Dictionary <String, Directory<global ResolvableObject>> : Set <Assoc <String, Directory<global ResolvableObject>>>
...
/* method implementations */
      Assoc <String, Directory<global ResolvableObject>> AddAssoc (String key, Directory<global ResolvableObject> value) {
	  Assoc <String, Directory<global ResolvableObject>> a=>New (key, value);
	  Assoc <String, Directory<global ResolvableObject>> b = Add (a);
      ...
      Assoc <String, Directory<global ResolvableObject>> AssocAt (String key) {return FindObjectWithKey (key);}

      Directory<global ResolvableObject> AtKey (String key) {
	  Assoc <String, Directory<global ResolvableObject>> assoc = FindObjectWithKey (key);
      ...
      Assoc <String, Directory<global ResolvableObject>> FindObjectWithKey (String key) {
      ...
      Assoc <String, Directory<global ResolvableObject>> RemoveKey (String key) {
	  Assoc <String, Directory<global ResolvableObject>> assoc = FindObjectWithKey (key);
      ...
      Directory<global ResolvableObject> SetAtKey (String key, Directory<global ResolvableObject> data) {
	  Assoc <String, Directory<global ResolvableObject>> assoc = FindObjectWithKey (key);
	  ...
	  Assoc <String, Directory<global ResolvableObject>> assoc;
