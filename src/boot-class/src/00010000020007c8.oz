...
class Iterator <OIDAsKey<global DirectoryServer<global ResolvableObject>>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <OIDAsKey<global DirectoryServer<global ResolvableObject>>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <OIDAsKey<global DirectoryServer<global ResolvableObject>>> collection) {
    ...
    OIDAsKey<global DirectoryServer<global ResolvableObject>> PostIncrement () {return aCollection->DoNext (self);}
