...
shared CollectionExceptions <OIDAsKey<global DirectoryServer<Package>>> {
    ElementNotFound (OIDAsKey<global DirectoryServer<Package>>  );
    Empty ();
    InternalError (OIDAsKey<global DirectoryServer<Package>>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (OIDAsKey<global DirectoryServer<Package>>  );
    UnknownKey (OIDAsKey<global DirectoryServer<Package>>  );
}
