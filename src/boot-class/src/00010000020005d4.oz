...
class Dictionary <String, int> : Set <Assoc <String, int>>
...
/* method implementations */
      Assoc <String, int> AddAssoc (String key, int value) {
	  Assoc <String, int> a=>New (key, value);
	  Assoc <String, int> b = Add (a);
      ...
      Assoc <String, int> AssocAt (String key) {return FindObjectWithKey (key);}

      int AtKey (String key) {
	  Assoc <String, int> assoc = FindObjectWithKey (key);
      ...
      Assoc <String, int> FindObjectWithKey (String key) {
      ...
      Assoc <String, int> RemoveKey (String key) {
	  Assoc <String, int> assoc = FindObjectWithKey (key);
      ...
      int SetAtKey (String key, int data) {
	  Assoc <String, int> assoc = FindObjectWithKey (key);
