...
shared CollectionExceptions <Assoc<String,global ResolvableObject>> {
    ElementNotFound (Assoc<String,global ResolvableObject>  );
    Empty ();
    InternalError (Assoc<String,global ResolvableObject>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,global ResolvableObject>  );
    UnknownKey (Assoc<String,global ResolvableObject>  );
}
