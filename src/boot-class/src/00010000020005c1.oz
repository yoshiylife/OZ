...
class Iterator <Assoc<OIDAsKey<T>,T>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <Assoc<OIDAsKey<T>,T>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <Assoc<OIDAsKey<T>,T>> collection) {
    ...
    Assoc<OIDAsKey<T>,T> PostIncrement () {return aCollection->DoNext (self);}
