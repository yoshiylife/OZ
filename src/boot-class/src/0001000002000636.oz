...
class Dictionary <String, global ResolvableObject> : Set <Assoc <String, global ResolvableObject>>
...
/* method implementations */
      Assoc <String, global ResolvableObject> AddAssoc (String key, global ResolvableObject value) {
	  Assoc <String, global ResolvableObject> a=>New (key, value);
	  Assoc <String, global ResolvableObject> b = Add (a);
      ...
      Assoc <String, global ResolvableObject> AssocAt (String key) {return FindObjectWithKey (key);}

      global ResolvableObject AtKey (String key) {
	  Assoc <String, global ResolvableObject> assoc = FindObjectWithKey (key);
      ...
      Assoc <String, global ResolvableObject> FindObjectWithKey (String key) {
      ...
      Assoc <String, global ResolvableObject> RemoveKey (String key) {
	  Assoc <String, global ResolvableObject> assoc = FindObjectWithKey (key);
      ...
      global ResolvableObject SetAtKey (String key, global ResolvableObject data) {
	  Assoc <String, global ResolvableObject> assoc = FindObjectWithKey (key);
