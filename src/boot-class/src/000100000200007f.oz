 ...
 * clfr.oz
 *
 * Class list file reader.
 */

class ClassListFileReader : FileReader {
  constructor: New;
  public: ReadDefault, ReadInteger, ReadObjectID, ReadString;
...
/* method implementations */
	...
	ClassListFileTokenReader tr=>New (file_name);
