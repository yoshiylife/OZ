...
class Iterator <Assoc<String,Directory<global ResolvableObject>>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <Assoc<String,Directory<global ResolvableObject>>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <Assoc<String,Directory<global ResolvableObject>>> collection) {
    ...
    Assoc<String,Directory<global ResolvableObject>> PostIncrement () {return aCollection->DoNext (self);}
