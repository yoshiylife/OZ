...
abstract class SequencedCollection <MirrorOperation> : Collection <MirrorOperation> {
...
/* abstract methods */
    MirrorOperation At (unsigned int index) : abstract;
    void AtAllPut (MirrorOperation o) : abstract;
...
/* method implementations */
    MirrorOperation DoNext (Iterator <MirrorOperation> i) {
    ...
    MirrorOperation First () {return At (0);}
