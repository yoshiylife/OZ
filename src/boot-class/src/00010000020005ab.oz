...
class Iterator <Assoc<String,global DirectoryServer<T>>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <Assoc<String,global DirectoryServer<T>>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <Assoc<String,global DirectoryServer<T>>> collection) {
    ...
    Assoc<String,global DirectoryServer<T>> PostIncrement () {return aCollection->DoNext (self);}
