 ...
 * nclfr.oz
 *
 * New class list file reader.
 */

class NewClassListFileReader : FileReader {
  constructor: New;
  public: IsEndOfToken, ReadInteger, ReadObjectID;
...
/* method implementations */
	...
	NewClassListFileTokenReader tr=>New (file_name);
