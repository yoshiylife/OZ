...
class Iterator <OIDAsKey<global DirectoryServer<T>>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <OIDAsKey<global DirectoryServer<T>>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <OIDAsKey<global DirectoryServer<T>>> collection) {
    ...
    OIDAsKey<global DirectoryServer<T>> PostIncrement () {return aCollection->DoNext (self);}
