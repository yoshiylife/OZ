...
shared CollectionExceptions <OIDAsKey<global ClassID>> {
    ElementNotFound (OIDAsKey<global ClassID>  );
    Empty ();
    InternalError (OIDAsKey<global ClassID>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (OIDAsKey<global ClassID>  );
    UnknownKey (OIDAsKey<global ClassID>  );
}
