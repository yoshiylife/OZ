...
class SimpleTable <global ClassPackageID, OriginalClassPackage> {
/* interface */
...
/* method implementations */
    ...
    OriginalClassPackage Add (global ClassPackageID k, OriginalClassPackage v) : locked {
	OriginalClassPackage ret;
	unsigned int index;
    ...
    OriginalClassPackage AtKey (global ClassPackageID k) : locked {
    ...
    OriginalClassPackage At (unsigned int i) : locked {
	if (KeyTable [i] == 0) {
	    return 0;
	} else {
	    return Table [i];
	...
	OriginalClassPackage tmp_table [] = Table;
    ...
    OriginalClassPackage RemoveKey (global ClassPackageID k) : locked {
	unsigned int index = FindIndexOf (k);
	...
	if (KeyTable [index] == 0) {
	    ...
	    OriginalClassPackage ret = Table [index];
