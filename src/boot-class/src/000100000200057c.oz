...
class Dictionary <String, T> : Set <Assoc <String, T>>
...
/* method implementations */
      Assoc <String, T> AddAssoc (String key, T value) {
	  Assoc <String, T> a=>New (key, value);
	  Assoc <String, T> b = Add (a);
      ...
      Assoc <String, T> AssocAt (String key) {return FindObjectWithKey (key);}

      T AtKey (String key) {
	  Assoc <String, T> assoc = FindObjectWithKey (key);
      ...
      Assoc <String, T> FindObjectWithKey (String key) {
      ...
      Assoc <String, T> RemoveKey (String key) {
	  Assoc <String, T> assoc = FindObjectWithKey (key);
