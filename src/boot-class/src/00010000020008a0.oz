...
shared CollectionExceptions <MirrorOperation> {
    ElementNotFound (MirrorOperation  );
    Empty ();
    InternalError (MirrorOperation  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (MirrorOperation  );
    UnknownKey (MirrorOperation  );
}
