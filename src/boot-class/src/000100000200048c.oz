...
abstract class SequencedCollection <String> : Collection <String> {
...
/* abstract methods */
    String At (unsigned int index) : abstract;
    void AtAllPut (String o) : abstract;
...
/* method implementations */
    String DoNext (Iterator <String> i) {
