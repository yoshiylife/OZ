...
class Station {
  public: GetName, Uptime, LoadAverage;
  protected: Name;
...
/* method implementations */
    /* returns station name on which the executor is running. */
    char GetName ()[] : locked {return Name;}

    /* returns duration from starting up the station. */
    Time Uptime () {
	/* Low implementation prioirty */
    }

    /* returns load average of the station */
