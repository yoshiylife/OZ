...
class Iterator <OIDAsKey<global DirectoryServer<Package>>> {
  constructor: New;
  public:
...
/* instance variables */
    Collection <OIDAsKey<global DirectoryServer<Package>>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <OIDAsKey<global DirectoryServer<Package>>> collection) {
    ...
    OIDAsKey<global DirectoryServer<Package>> PostIncrement () {return aCollection->DoNext (self);}
