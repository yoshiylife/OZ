...
abstract class Collection <Assoc<String,T>> {
...
/* abstract methods */
    Assoc<String,T> Add (Assoc<String,T> content) : abstract;
    Assoc<String,T> DoNext (Iterator <Assoc<String,T>> i) : abstract;
    unsigned int Hash () : abstract;
    int IsEqual (Collection <Assoc<String,T>> collection) : abstract;
    unsigned int OccurrencesOf (Assoc<String,T> content) : abstract;
    Assoc<String,T> Remove (Assoc<String,T> content) : abstract;

/* method inplementation */
    Collection <Assoc<String,T>> AddAll (Collection <Assoc<String,T>> collection) {
	collection->AddContentsTo (self);
	return collection;
    }

    Collection <Assoc<String,T>> AddContentsTo (Collection <Assoc<String,T>> collection){
    ...
    Assoc<String,T> AsArray () [] {
	Assoc<String,T> array [];
	Iterator <Assoc<String,T>> i;
	Assoc<String,T> t;
	unsigned int j = 0;
    ...
    void DoFinish (Iterator <Assoc<String,T>> i) {}

    void DoReset (Iterator <Assoc<String,T>> i) {}

    int Includes (Assoc<String,T> content) {return OccurrencesOf (content) != 0;}
    ...
    void NewWithCollection (Collection <Assoc<String,T>> collection) {
	New ();
	AddAll (collection);
    }

    Collection <Assoc<String,T>> RemoveAll (Collection <Assoc<String,T>> collection) {
	Iterator <Assoc<String,T>> i;
	Assoc<String,T> content;
