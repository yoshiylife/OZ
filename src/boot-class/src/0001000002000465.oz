...
class Set <String> : Collection <String>
  (rename New SuperNew;
...
/* method implementations */
    ...
    Set <String> AddContentsTo (Set <String> collection){
    ...
    Set <String> Difference (Set <String> s) {
	unsigned int i;
	Set <String> diff = ShallowCopy ();
    ...
    String DoNext (Iterator <String> pos) {
    ...
    String FindObjectWithKey (String key) {
    ...
    int IsEqual (Collection <String> s) {
	return IsSubSetOf (s) && IsSuperSetOf (s);
    }

    int IsSubSetOf (Collection <String> collection) {
    ...
    int IsSuperSetOf (Collection <String> collection) {
	if (Count < collection->Size ()) {
	    return 0;
	} else {
	    Iterator <String> i=>New (collection);
	    String c;
     ...
     */
    unsigned int OccurrencesOf (String t) {
	...
	unsigned int i = FindIndexOf (t);
	String rob = Contents [i];

	if (rob == 0) {
	    raise CollectionExceptions<String>::ElementNotFound (t);
	} else {
	    unsigned int j, r;
	...
	if (new_size <= Count) {
	    raise
	      CollectionExceptions<String>::InvalidIntParameter (new_size);
	}
	if (Count > 0) {
	    unsigned int n = length Contents;
    ...
    Set <String> Intersection (Set <String> s) {
	Set <String> set_intersection = ShallowCopy ();
	unsigned int n = length Contents;
	unsigned int i;
    ...
    Set <String> ShallowCopy () {
	Iterator <String> i;
	String content;
	Set <String> new=>NewWithSize (Size ());
    ...
    Set <String> Union (Set <String> s) {
	Set <String> set_union = ShallowCopy ();
...
/* protected method implementations below */
     ...
     */
    unsigned int FindIndexOf (String t) {
	unsigned int i;
