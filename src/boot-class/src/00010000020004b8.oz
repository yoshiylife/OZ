...
shared CollectionExceptions <global Object> {
    ElementNotFound (global Object  );
    Empty ();
    InternalError (global Object  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (global Object  );
    UnknownKey (global Object  );
}
