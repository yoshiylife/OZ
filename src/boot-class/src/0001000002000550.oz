...
abstract class Collection <OIDAsKey<global ClassID>> {
...
/* abstract methods */
    OIDAsKey<global ClassID> Add (OIDAsKey<global ClassID> content) : abstract;
    OIDAsKey<global ClassID> DoNext (Iterator <OIDAsKey<global ClassID>> i) : abstract;
    unsigned int Hash () : abstract;
    int IsEqual (Collection <OIDAsKey<global ClassID>> collection) : abstract;
    unsigned int OccurrencesOf (OIDAsKey<global ClassID> content) : abstract;
    OIDAsKey<global ClassID> Remove (OIDAsKey<global ClassID> content) : abstract;

/* method inplementation */
    Collection <OIDAsKey<global ClassID>> AddAll (Collection <OIDAsKey<global ClassID>> collection) {
	collection->AddContentsTo (self);
	return collection;
    }

    Collection <OIDAsKey<global ClassID>> AddContentsTo (Collection <OIDAsKey<global ClassID>> collection){
    ...
    OIDAsKey<global ClassID> AsArray () [] {
	OIDAsKey<global ClassID> array [];
	Iterator <OIDAsKey<global ClassID>> i;
	OIDAsKey<global ClassID> t;
	unsigned int j = 0;
    ...
    void DoFinish (Iterator <OIDAsKey<global ClassID>> i) {}

    void DoReset (Iterator <OIDAsKey<global ClassID>> i) {}

    int Includes (OIDAsKey<global ClassID> content) {return OccurrencesOf (content) != 0;}
    ...
    void NewWithCollection (Collection <OIDAsKey<global ClassID>> collection) {
	New ();
	AddAll (collection);
    }

    Collection <OIDAsKey<global ClassID>> RemoveAll (Collection <OIDAsKey<global ClassID>> collection) {
	Iterator <OIDAsKey<global ClassID>> i;
	OIDAsKey<global ClassID> content;
