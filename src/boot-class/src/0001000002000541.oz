...
abstract class Collection <Assoc<String,String>> {
...
/* abstract methods */
    Assoc<String,String> Add (Assoc<String,String> content) : abstract;
    Assoc<String,String> DoNext (Iterator <Assoc<String,String>> i) : abstract;
    unsigned int Hash () : abstract;
    int IsEqual (Collection <Assoc<String,String>> collection) : abstract;
    unsigned int OccurrencesOf (Assoc<String,String> content) : abstract;
    Assoc<String,String> Remove (Assoc<String,String> content) : abstract;

/* method inplementation */
    Collection <Assoc<String,String>> AddAll (Collection <Assoc<String,String>> collection) {
	collection->AddContentsTo (self);
	return collection;
    }

    Collection <Assoc<String,String>> AddContentsTo (Collection <Assoc<String,String>> collection){
    ...
    Assoc<String,String> AsArray () [] {
	Assoc<String,String> array [];
	Iterator <Assoc<String,String>> i;
    ...
    void DoFinish (Iterator <Assoc<String,String>> i) {}

    void DoReset (Iterator <Assoc<String,String>> i) {}

    int Includes (Assoc<String,String> content) {return OccurrencesOf (content) != 0;}
    ...
    void NewWithCollection (Collection <Assoc<String,String>> collection) {
	New ();
	AddAll (collection);
    }

    Collection <Assoc<String,String>> RemoveAll (Collection <Assoc<String,String>> collection) {
	Iterator <Assoc<String,String>> i;
	Assoc<String,String> content;
