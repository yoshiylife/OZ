...
shared CollectionExceptions <Assoc<String,Directory<Package>>> {
    ElementNotFound (Assoc<String,Directory<Package>>  );
    Empty ();
    InternalError (Assoc<String,Directory<Package>>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,Directory<Package>>  );
    UnknownKey (Assoc<String,Directory<Package>>  );
}
