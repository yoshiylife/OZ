...
/* method implementations */
    void New (String key, String value) {
	aKey = key;
	aValue = value;
    }

    int Compare (Assoc <String, String> assoc) {
	return aKey->Compare (assoc->Key ());
    }

    unsigned int Hash () {return aKey->Hash ();}

    int IsEqual (Assoc <String, String> assoc) {
    ...
    String SetValue (String new_value) {
	String tmp = aValue;
	aValue = new_value;
	return tmp;
    }
