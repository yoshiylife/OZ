...
/* instance variables */
    Collection <ProjectLinkSS> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <ProjectLinkSS> collection) {
    ...
    ProjectLinkSS PostIncrement () {return aCollection->DoNext (self);}
