...
shared CollectionExceptions <Assoc<String,global DirectoryServer<T>>> {
    ElementNotFound (Assoc<String,global DirectoryServer<T>>  );
    Empty ();
    InternalError (Assoc<String,global DirectoryServer<T>>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,global DirectoryServer<T>>  );
    UnknownKey (Assoc<String,global DirectoryServer<T>>  );
}
