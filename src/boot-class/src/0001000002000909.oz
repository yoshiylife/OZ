...
shared CollectionExceptions <OIDAsKey<global DirectoryServer<global ResolvableObject>>> {
    ElementNotFound (OIDAsKey<global DirectoryServer<global ResolvableObject>>  );
    Empty ();
    InternalError (OIDAsKey<global DirectoryServer<global ResolvableObject>>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (OIDAsKey<global DirectoryServer<global ResolvableObject>>  );
    UnknownKey (OIDAsKey<global DirectoryServer<global ResolvableObject>>  );
}
