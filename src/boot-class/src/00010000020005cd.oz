...
class Set <Assoc<String,String>> : Collection <Assoc<String,String>>
  (rename New SuperNew;
...
/* method implementations */
    ...
    Assoc<String,String> Add (Assoc<String,String> t) {
    ...
    Set <Assoc<String,String>> AddContentsTo (Set <Assoc<String,String>> collection){
    ...
    Set <Assoc<String,String>> Difference (Set <Assoc<String,String>> s) {
	unsigned int i;
	Set <Assoc<String,String>> diff = ShallowCopy ();
    ...
    Assoc<String,String> DoNext (Iterator <Assoc<String,String>> pos) {
    ...
    Assoc<String,String> FindObjectWithKey (Assoc<String,String> key) {
    ...
    int IsEqual (Collection <Assoc<String,String>> s) {
	return IsSubSetOf (s) && IsSuperSetOf (s);
    }

    int IsSubSetOf (Collection <Assoc<String,String>> collection) {
    ...
    int IsSuperSetOf (Collection <Assoc<String,String>> collection) {
	if (Count < collection->Size ()) {
	    return 0;
	} else {
	    Iterator <Assoc<String,String>> i=>New (collection);
	    Assoc<String,String> c;
     ...
     */
    unsigned int OccurrencesOf (Assoc<String,String> t) {
     ...
     */
    Assoc<String,String> Remove (Assoc<String,String> t) {
	unsigned int i = FindIndexOf (t);
	Assoc<String,String> rob = Contents [i];

	if (rob == 0) {
	    raise CollectionExceptions<Assoc<String,String>>::ElementNotFound (t);
	} else {
	    unsigned int j, r;
    ...
    Assoc<String,String> RemoveAny () {
	if (Size () == 0) {
	    raise CollectionExceptions<Assoc<String,String>>::Empty;
	} else {
	    unsigned int n = length Contents, i;
	...
	if (new_size <= Count) {
	    raise
	      CollectionExceptions<Assoc<String,String>>::InvalidIntParameter (new_size);
	}
	if (Count > 0) {
	    unsigned int n = length Contents;
	    Assoc<String,String> old_contents [] = Contents;
	    Assoc<String,String> new_contents [];

	    length new_contents = SetCapacity (new_size);
	    Contents = new_contents;
	    for (i = 0; i < n; i ++) {
		Assoc<String,String> t = old_contents [i];
		if (t != 0) {
		    Add (t);
		}
	    }
    ...
    Set <Assoc<String,String>> Intersection (Set <Assoc<String,String>> s) {
	Set <Assoc<String,String>> set_intersection = ShallowCopy ();
	unsigned int n = length Contents;
	unsigned int i;
    ...
    Set <Assoc<String,String>> ShallowCopy () {
	Iterator <Assoc<String,String>> i;
	Assoc<String,String> content;
	Set <Assoc<String,String>> new=>NewWithSize (Size ());
    ...
    Set <Assoc<String,String>> Union (Set <Assoc<String,String>> s) {
	Set <Assoc<String,String>> set_union = ShallowCopy ();
...
/* protected method implementations below */
     ...
     */
    unsigned int FindIndexOf (Assoc<String,String> t) {
	unsigned int i;
