...
/* instance variables */
    Collection <OIDAsKey<T>> aCollection;
    int Index;
    unsigned int Num;

/* method implementations */
    void New (Collection <OIDAsKey<T>> collection) {
    ...
    OIDAsKey<T> PostIncrement () {return aCollection->DoNext (self);}
