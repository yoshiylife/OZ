...
shared CollectionExceptions <Assoc<String,Directory<global ResolvableObject>>> {
    ElementNotFound (Assoc<String,Directory<global ResolvableObject>>  );
    Empty ();
    InternalError (Assoc<String,Directory<global ResolvableObject>>  );
    InvalidIntParameter (int);
    InvalidParameter ();
    RedefinitionOfKey (Assoc<String,Directory<global ResolvableObject>>  );
    UnknownKey (Assoc<String,Directory<global ResolvableObject>>  );
}
