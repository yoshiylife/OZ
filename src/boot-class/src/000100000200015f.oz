 ...
 * dir-exc.oz
 *
 * Exceptions from directory class library
 */

shared DirectoryExceptions {
    IllegalPathString (String);
    CannotCreateDirectoryServer ();
    DomainConfliction (String);
    NotEmtpy ();
    OverWriteProhibited (String);
    UnknownDirectory (String);
    UnknownDirectoryServer (global ResolvableObject);
    UnknownEntry (String);
}
