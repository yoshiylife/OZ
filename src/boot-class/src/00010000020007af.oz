...
class Dictionary <String, global DirectoryServer<global ResolvableObject>> : Set <Assoc <String, global DirectoryServer<global ResolvableObject>>>
...
/* method implementations */
      Assoc <String, global DirectoryServer<global ResolvableObject>> AddAssoc (String key, global DirectoryServer<global ResolvableObject> value) {
	  Assoc <String, global DirectoryServer<global ResolvableObject>> a=>New (key, value);
	  Assoc <String, global DirectoryServer<global ResolvableObject>> b = Add (a);
      ...
      Assoc <String, global DirectoryServer<global ResolvableObject>> AssocAt (String key) {return FindObjectWithKey (key);}

      global DirectoryServer<global ResolvableObject> AtKey (String key) {
	  Assoc <String, global DirectoryServer<global ResolvableObject>> assoc = FindObjectWithKey (key);
      ...
      Assoc <String, global DirectoryServer<global ResolvableObject>> FindObjectWithKey (String key) {
      ...
      Assoc <String, global DirectoryServer<global ResolvableObject>> RemoveKey (String key) {
	  Assoc <String, global DirectoryServer<global ResolvableObject>> assoc = FindObjectWithKey (key);
      ...
      global DirectoryServer<global ResolvableObject> SetAtKey (String key, global DirectoryServer<global ResolvableObject> data) {
	  Assoc <String, global DirectoryServer<global ResolvableObject>> assoc = FindObjectWithKey (key);
