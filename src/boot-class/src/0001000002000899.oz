...
abstract class Collection <MirrorOperation> {
...
/* abstract methods */
    MirrorOperation Add (MirrorOperation content) : abstract;
    MirrorOperation DoNext (Iterator <MirrorOperation> i) : abstract;
    unsigned int Hash () : abstract;
    int IsEqual (Collection <MirrorOperation> collection) : abstract;
    unsigned int OccurrencesOf (MirrorOperation content) : abstract;
    MirrorOperation Remove (MirrorOperation content) : abstract;

/* method inplementation */
    Collection <MirrorOperation> AddAll (Collection <MirrorOperation> collection) {
	collection->AddContentsTo (self);
	return collection;
    }

    Collection <MirrorOperation> AddContentsTo (Collection <MirrorOperation> collection){
	Iterator <MirrorOperation> i;
	MirrorOperation content;
    ...
    void DoFinish (Iterator <MirrorOperation> i) {}

    void DoReset (Iterator <MirrorOperation> i) {}

    int Includes (MirrorOperation content) {return OccurrencesOf (content) != 0;}
    ...
    void NewWithCollection (Collection <MirrorOperation> collection) {
	New ();
	AddAll (collection);
    }

    Collection <MirrorOperation> RemoveAll (Collection <MirrorOperation> collection) {
	Iterator <MirrorOperation> i;
	MirrorOperation content;
