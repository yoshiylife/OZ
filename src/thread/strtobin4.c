...
/*
 *	Reentrant convert string to binary 4 bytes
 *
...
{
	u_long	result_val = 0ULL ;		/* result value */
const	u_char	*result_ptr = str ;		/* result pointer */
	...
	u_long	overQ ;				/* overflow quotient limit */
	u_long	overR ;				/* overflow residual limit */
	u_long	overL ;				/* overflow limit value */
