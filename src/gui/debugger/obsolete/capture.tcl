...
wm title . "MessageServer"
wm iconname . "MessageServer"
frame .ribon ;
...
#	wm maxsize $w 442 [winfo screenheight $w] ;
	...
	frame $w.ribon ;
	button $w.ribon.save -text "Save" -command "puts stdout Save ; flush stdout" ;
	button $w.ribon.quit -text "Close" -command "destroy $w" ;
	pack $w.ribon.save -side left ;
	pack $w.ribon.quit -side right ;

	frame $w.log -relief raised -borderwidth 1 ;
	text $w.log.msg -relief sunken -borderwidth 1 -width 80 -height 24 \
...
#set head "0x12345678 0x12345678 x 1234567890123456 1234567890123456 1234567890123456 test message"
